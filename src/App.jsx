     ...
     alt="heropics"/>
      ...
      {/* Second Background */}
               ...
               {/*  Background Image */}
                ...
                {/* Section Title */} 
                <div className='absolute flex top-10 md:top-0 text-1xl w-full md:text-5xl text-center justify-center md:justify-start text-[#FFFFFF] ml-32 mt-24 md:ml-36 md:mt-28 
                '>                
