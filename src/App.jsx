...
//   const [count, setCount] = useState(0)
  ...
  return (
    ...
    <div className="min-h-screen overflow-x-hidden">
        <header className="fixed top-0 w-full z-10 bg-[#222831] items-center px-4 py-4 md:px-8 lg:px-24 border-b-2 border-cyan-900">
          ...
          />
            ...
            {/* Hero Info */}
            <h1 className="text-[#FFFFFF] text-5xl md:text-9xl lg:text-[84px] font-extrabold font-poppins mt-20 md:mt-0 lg:mt-0 px-6 md:px-0 lg:px-0"> 
