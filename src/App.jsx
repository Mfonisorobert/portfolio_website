...
<div>
    ...
    <img src='/steps.svg' className='md:ml-72 items-center justify-center ml-14'>
    </img>
</div>


{/* Forms section */}
<div className="min-h-screen items-center justify-center p-4 md:mr-24 mt-28 md:mt-32">
